# UNIDAD 1. Marco normativo y fundamentos del Proyecto Intermodular
...
https://www.gobiernodecanarias.org/boc/2025/148/index.html

Instrucciones de descarga PDF del "Boletín Oficial de Canarias núm. 148":
- Ir a sección "III. Otras Resoluciones"
- Ir a apartado "Consejería de Educación, Formación Profesional, Actividad Física y Deportes".
- Hacer click en "2729 Dirección General de Formación Profesional y Enseñanzas de Régimen Especial.- Resolución de 18 de julio de 2025,...".

## Artículos y/o aspectos a destacar de la norma que afectan a la programación del Proyecto Intermodular.

La parte importante en mi centro (Grado Medio y Superior en modalidad presencial) se encuentra en el Anexo I, INSTRUCCIONES PARA LA ORGANIZACIÓN DEL MÓDULO DE PROYECTO INTERMODULAR.
A continuación cito los párrafos más llamativos y la instrucción en la que se encuentran:

### En cuanto a ORGANIZACIÓN TEMPORAL
Cuarta punto tres:
> Con carácter general, las 64 horas asignadas al módulo de Proyecto intermodular deberán organizarse atendiendo a las siguientes reglas:
...
Cuarta punto 3:
> Los centros docentes planificarán en su programación general anual que 28 horas correspondientes al módulo de Proyecto intermodular se impartan la semana previa a la
incorporación del alumnado a la FEOE , con la participación de todo el equipo educativo desde sus módulos. Esta participación propicia la colaboración activa entre el desarrollo del
Proyecto intermodular y el módulo Itinerario para la empleabilidad II del ciclo formativo, con el fin de favorecer, además de los objetivos del primero, la integración efectiva de los
aprendizajes y las competencias adquiridas por el alumnado.

### En cuanto a EVALUACIÓN
Segunda punto 2:
> El Proyecto intermodular tendrá carácter grupal, salvo excepciones justificadas. Con independencia de dicho carácter, la evaluación y calificación será individual y deberá presentarse de manera oral ante el equipo docente, al que podrá incorporarse el tutor o tutora de empresa.
